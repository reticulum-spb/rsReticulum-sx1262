...
typedef struct rns_host_api {
    ...
    void (*rx_packet)(void *, const uint8_t *, size_t, const rns_rx_metadata_t *, size_t);
} rns_host_api_t;
...
typedef struct rns_plugin_api {
    ...
    size_t                   info_size;
    rns_plugin_result_t (*create)(const rns_host_api_t *, const uint8_t *, size_t, rns_plugin_t **);
